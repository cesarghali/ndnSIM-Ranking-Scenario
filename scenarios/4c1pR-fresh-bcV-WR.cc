  ...
  for (int i = 0; i < (1 / BAD_CONTENT_RATE_STEP) + 1; i++)
    {
      ...
      p2p.Install (nodes.Get (0), nodes.Get (4));    // 4 is the router
      p2p.Install (nodes.Get (1), nodes.Get (4));
      p2p.Install (nodes.Get (2), nodes.Get (4));
      p2p.Install (nodes.Get (3), nodes.Get (4));
      p2p.Install (nodes.Get (4), nodes.Get (5));    // 5 is the producer
      ...
      ccnxHelperWithCache.Install (nodes.Get (4));
      ...
      ccnxHelperNoCache.Install (nodes.Get (0));
      ccnxHelperNoCache.Install (nodes.Get (1));
      ccnxHelperNoCache.Install (nodes.Get (2));
      ccnxHelperNoCache.Install (nodes.Get (3));
      ccnxHelperNoCache.Install (nodes.Get (5));
